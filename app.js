...
function toggleAttendance(vid,mid){var v=state.vendors.find(x=>x.id===vid);if(!v)return;if(!v.marketAttendance)v.marketAttendance={};v.marketAttendance[mid]=!v.marketAttendance[mid];sbSave('vendors',vendorToDb(v));}
